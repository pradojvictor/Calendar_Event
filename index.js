const calendar = document.querySelector(".calendar"),
    ...
    addEventSubmit = document.querySelector(".add-event-bnt"),
    addEventBtn = document.querySelector(".add-event"),
    addEventContainer = document.querySelector(".add-event-wrapper"),
    addEventCloseBnt = document.querySelector(".close"),
...
todayBnt.addEventListener("click", () => {
    today = new Date();
...
addEventCloseBnt.addEventListener("click", () => {
...
eventsContainer.addEventListener("click", (e) => {
    if (e.target.classList.contains("event")) {
        if (confirm("Você quer APAGAR esse pedido?")) {
